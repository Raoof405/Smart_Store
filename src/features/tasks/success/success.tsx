...
import DeleteTaskSuccess from "./components/DeleteTaskSuccess";
import EditeTaskSuccess from "./components/EditeTaskSuccess";
    ...
    try {
      const response = await axiosIns.get<ApiResponse>(
        `/dashboard/task/index`,
        {
          params: {
            filters: {
              status: "done", // done   or any other status you need
            },
          },
        }
      );
