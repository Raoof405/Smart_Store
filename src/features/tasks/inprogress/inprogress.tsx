...
import EditeTaskInProgress from "./components/EditeTaskInProgress";
import DeleteTaskInProgress from "./components/DeleteTaskInProgress";
import PartsSkeleton from "@/shared/components/TableSkeleton";
import NoData from "@/shared/components/NoData";
import EditeTaskPending from "../pending/components/EditeTaskPending";
import DeleteTaskPending from "../pending/components/DeleteTaskPending";
                    ...
                    {tasks.map((task) => (
                      ...
                      >
                        ...
                        <TableCell align="center">
                          ...
                          {/* <EditeTaskInProgress id={task.id} />
                          <DeleteTaskInProgress id={task.id} /> */}
                        </TableCell>
                      </TableRow>
                    ))}
                  </TableBody>
